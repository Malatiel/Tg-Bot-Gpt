...
| `OPENAI_TEMPERATURE_UNSUPPORTED_MODELS` | optional | Comma-separated model-name prefixes that reject a custom temperature; it is omitted for them (avoids 400s). Defaults to `gpt-5.6`, whose reasoning models reject a custom temperature |
